...
class Player : GameObject
{
	...
	public ref @property int x()
	{
		return m_x;
	}
	public ref @property int y()
	{
		return m_y;
	}

	public @property int topState()
	{
		return m_topState;
	}

	public ref @property int topX()
	{
		return m_topX;
	}
	public ref @property int topY()
	{
		return m_topY;
	}
	...
	public @property vec3 topPosition()
	{
		return m_top.transform.position;
	}

	public @property Transform bottomTransform()
	{
		return m_bottom.transform;
	}
	public @property Transform topTransform()
	{
		return m_top.transform;
	}

	public @property i32vec2 respawnPosition()
	{
		return i32vec2(m_respawnX, m_respawnY);
	}
	public @property void respawnPosition(i32vec2 pos)
	{
		m_respawnX = pos.x; m_respawnY = pos.y;
	}

	public @property i32vec2 finishPosition()
	{
		return i32vec2(m_targetX, m_targetY);
	}
	public @property void finishPosition(i32vec2 pos)
	{
		m_targetX = pos.x; m_targetY = pos.y;
	}
	...
	public int getDirection()
	{
		...
		if (rota >= 45 && rota < 135)
			return 1;
		if (rota >= 135 && rota < 225)
			return 2;
		if (rota >= 225 && rota < 315)
			return 3;
		return 0;
	}
	...
	public void moveRight()
	{
		...
		if (m_topState == 0)
		{
			if (dir == 0)
			{
				m_animationType = AnimationType.X; m_topState = 1;
			}
			if (dir == 1)
			{
				m_animationType = AnimationType.NZ; m_topState = 4;
			}
			if (dir == 2)
			{
				m_animationType = AnimationType.NX; m_topState = 2;
			}
			if (dir == 3)
			{
				m_animationType = AnimationType.Z; m_topState = 3;
			}
		}
